...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Result.title'
        db.add_column('ella_quizzes_result', 'title',
                      self.gf('django.db.models.fields.CharField')(default='Quiz Result', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Result.title'
        db.delete_column('ella_quizzes_result', 'title')
